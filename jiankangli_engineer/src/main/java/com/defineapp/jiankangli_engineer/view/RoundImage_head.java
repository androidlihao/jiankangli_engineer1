 ...
 * @author 
 */
public class RoundImage_head extends ImageView {
    ...
    public RoundImage_head(Context context) {
        super(context);
        mContext = context;
    }

    public RoundImage_head(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
//        setCustomAttributes(attrs);
    }

    public RoundImage_head(Context context, AttributeSet attrs, int defStyle) {
