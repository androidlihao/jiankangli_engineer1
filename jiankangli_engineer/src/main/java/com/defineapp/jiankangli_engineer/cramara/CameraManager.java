...
package com.defineapp.jiankangli_engineer.cramara;
...
public final class CameraManager {
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int width = context.getResources().getDimensionPixelSize(R.dimen.px_680);
			int left = context.getResources().getDimensionPixelSize(R.dimen.px_282);
			int top = context.getResources().getDimensionPixelSize(R.dimen.px_472);
			framingRect = new Rect(left, top, left + width, top + width);
